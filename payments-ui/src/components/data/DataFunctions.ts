...
export const getAllPaymentsRestVersion = (): void => {
    const responsePromise: Promise<Response> = fetch('https://payments.multicode.uk/api/payment', 
...
export const getAllPayments= (): Promise<Response> => {
    return fetch('https://payments.multicode.uk/api/payment', 
    { method: 'GET', headers: { 'Accept': 'application/json'}});
}

export const getAllPaymentsAxios= (): Promise<AxiosResponse<PaymentType[]>> => {
